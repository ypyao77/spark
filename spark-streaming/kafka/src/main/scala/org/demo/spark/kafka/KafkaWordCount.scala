...
/**
  ...
  *
  *    e.g.
  *    $ spark2-submit --queue root.hadoop.plarch --master local --deploy-mode client --class org.demo.spark.kafka.KafkaWordCount target/kafka-1.0.0.jar oddev03:2181,oddev04:2181,oddev05:2181/kafka streaming-demo mygroup 3
  */
